...
public class Application {
        ...
        while (in.hasNextLine()) { //while remain one and more line in file we do :
            ...
            switch(figureName) { 
                case "Ellipse": 
                    ...
                    } catch (ArguesInvalidEx ex) {
                        out.write(figureName + "'s " + ex.getMessage());
                    }
                    break;
                case "Box": 
     ...
     * */
    public static void ellipseSquare(Scanner in, PrintWriter out) throws ArguesInvalidEx {                
     ...
     * @param in, out - files for reading, writing
     * */
    public static void circleSquare(Scanner in, PrintWriter out) throws ArguesInvalidEx {
